...
public interface StreamSerializer
{
	...
	public static StreamSerializer New()
	{
		return new StreamSerializer.Default(SerializerFoundation.New());
	}
	
	
	public static StreamSerializer New(final SerializerFoundation<?> foundation)
	{
		return new StreamSerializer.Default(foundation);
	}
	
	
	
	public static class Default implements StreamSerializer
	{
