...
public class DataStoragePrimitiveDeserializer implements DataStorageDeserializer
{
    ...
    {
        // FIXME
        throw new UnsupportedOperationException("Converting a Reference to a primitive is not possible");
    }
}
