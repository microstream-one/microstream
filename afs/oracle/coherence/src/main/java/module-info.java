 ...
 * #L%
 */
module microstream.afs.ocacle.coherence
{
	exports one.microstream.afs.oracle.coherence.types;
	
	provides one.microstream.configuration.types.ConfigurationBasedCreator
	    with one.microstream.afs.oracle.coherence.types.OracleCoherenceFileSystemCreator
	;
