...
//		System.out.println("Line: " + s.substring(newLineIndex + 1, endIndex));
	...
	{
		final String fileContent = XFiles.readString(file.toPath(), XChars.defaultJvmCharset());
		...
		throws RuntimeException
	{
		try
		{
			final String fileContent = XFiles.readString(f.toPath(), XChars.defaultJvmCharset());
