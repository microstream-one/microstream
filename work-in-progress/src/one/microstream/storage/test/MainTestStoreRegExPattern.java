...
public class MainTestStoreRegExPattern
{
	static
	{
//		Test.clearDefaultStorageDirectory();
	...
	{
		final String  patternString = "\\d.+[0-3]*";
		final int     flags         = Pattern.CASE_INSENSITIVE | Pattern.MULTILINE;
		final Pattern pattern       = Pattern.compile(patternString, flags);
