...
//		final E removeMarker = elements.get();
	...
	{
		throw new one.microstream.meta.NotImplementedYetError(); // FIXME Processable<E>#process()
	}
	...
	{
		throw new one.microstream.meta.NotImplementedYetError(); // FIXME XRemovingSequence<E>#removeRange()
	}

	@Override
	public final long removeSelection(final long[] indices)
	{
		throw new one.microstream.meta.NotImplementedYetError(); // FIXME XRemovingSequence<E>#removeSelection()
	}
	...
	{
		throw new one.microstream.meta.NotImplementedYetError(); // FIXME XInsertingSequence<E>#insert()
	}

	@Override
	public final boolean nullInsert(final long index)
	{
		throw new one.microstream.meta.NotImplementedYetError(); // FIXME XInsertingSequence<E>#nullInsert()
	}
	...
	{
		throw new one.microstream.meta.NotImplementedYetError(); // FIXME XInsertingSequence<E>#insertAll()
	}
	...
	{
		throw new one.microstream.meta.NotImplementedYetError(); // FIXME XReplacingBag<E>#replaceOne()
	}

	@Override
	public final long replace(final E element, final E replacement)
	{
		throw new one.microstream.meta.NotImplementedYetError(); // FIXME XReplacingBag<E>#replace()
	}

	@Override
	public final long replaceAll(final XGettingCollection<? extends E> elements, final E replacement)
	{
		throw new one.microstream.meta.NotImplementedYetError(); // FIXME XReplacingBag<E>#replaceAll()
	}
	...
	{
		throw new one.microstream.meta.NotImplementedYetError(); // FIXME XReplacingBag<E>#modify()
	}
	...
	{
		throw new one.microstream.meta.NotImplementedYetError(); // FIXME XList<E>#setAll()
	}
	...
	{
		throw new one.microstream.meta.NotImplementedYetError(); // FIXME XList<E>#retainRange()
	}
