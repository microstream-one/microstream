...
public class MainTestCharsToString
{
...
//		ints = JaMath.randoming(SIZE, 100_000, 1_000_000);
	...
	{
		final VarString vs = VarString.New(SIZE * 10);
	...
	{
		final String s = VarString.New().addHexDec(b).toString();
	...
	{
		final String s = VarString.New().add(i).toString();
