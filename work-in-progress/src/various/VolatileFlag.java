...
public final class VolatileFlag
{
	...
	{
		return !JdkMemoryAccessor.staticCompareAndSwap_int(this, FIELD_OFFSET_state, 0, 1);
	}

	public final boolean off()
	{
		return JdkMemoryAccessor.staticCompareAndSwap_int(this, FIELD_OFFSET_state, 1, 0);
	}
