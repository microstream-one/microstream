...
Therefore you use the default storage <<Storing Data, API>>.
...
[IMPORTANT]
====
By default <<Lazy Loading, Lazy References>> are not loaded during startup. But they must be loaded to update all instances behind them.
====
