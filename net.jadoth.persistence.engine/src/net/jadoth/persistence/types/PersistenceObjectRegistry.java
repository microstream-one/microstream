...
//	public <P extends PersistencePredicate> P removeObjectsBy(P filter);
	...
	public static PersistenceObjectRegistry.Default New()
	{
		return New(Default.defaultHashDensity());
	}
	
	public static PersistenceObjectRegistry.Default New(final float desiredHashDensity)
	{
	...
	public final class Default implements PersistenceObjectRegistry
	{
		...
		final Default internalSetHashDensity(final float hashDensity)
		{
		...
		@Override
		public final synchronized Default setHashDensity(final float hashDensity)
		{
