...
//			if(instance.objectId != Swizzle.nullId())
//			{
//				return;
//			}
//			referenceOid = Swizzle.nullId();
		}
		else
		{
	...
	@Override
	public final void update(final Binary bytes, final Lazy<?> instance, final SwizzleBuildLinker builder)
	{
	...
	@Override
	public final void complete(final Binary medium, final Lazy<?> instance, final SwizzleBuildLinker builder)
	{
