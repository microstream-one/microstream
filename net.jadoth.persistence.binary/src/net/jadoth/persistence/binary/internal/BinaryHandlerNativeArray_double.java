...
public final class BinaryHandlerNativeArray_double extends AbstractBinaryHandlerNativeArrayPrimitive<double[]>
{
	...
	@Override
	public void store(final Binary bytes, final double[] array, final long oid, final PersistenceHandler handler)
	{
	...
	@Override
	public void update(final Binary bytes, final double[] instance, final PersistenceBuildLinker builder)
	{
