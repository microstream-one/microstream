...
public interface ZStorageFile
{
	...
	public default ZStorageFile flush()
	{
		try
		{
	...
	public static void close(final ZStorageFile file, final Throwable cause)
	{
		if(file == null)
		{
			return;
	...
	public static VarString assembleNameAndSize(final VarString vs, final ZStorageFile file)
	{
