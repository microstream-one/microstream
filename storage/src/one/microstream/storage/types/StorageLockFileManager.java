...
public interface StorageLockFileManager extends Runnable
{
	...
	public final class Default implements StorageLockFileManager, StorageReaderCallback
	{
		...
		private boolean ensureBufferCapacity(final int capacity)
		{
			 ...
			 */
			JdkInternals.deallocateDirectBuffer(this.directByteBuffer);
		...
		private void fillReadBufferFromFile()
		{
			...
			XMemory.copyRangeToArray(JdkInternals.getDirectBufferAddress(this.directByteBuffer), this.stringReadBuffer);
		}
...
//			);
			...
			XMemory.copyArrayToAddress(bytes, JdkInternals.getDirectBufferAddress(this.directByteBuffer));
