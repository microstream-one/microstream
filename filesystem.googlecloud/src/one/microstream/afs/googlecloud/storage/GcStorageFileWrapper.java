...
public interface GcStorageFileWrapper extends AFile.Wrapper, GcStorageItemWrapper
{
	...
	public GcStorageFileWrapper ensureOpenHandle();


	public abstract class Abstract<U> extends AFile.Wrapper.Abstract<U> implements GcStorageFileWrapper
	{
		///////////////////////////////////////////////////////////////////////////
		// instance fields //
		////////////////////

		private GcStoragePath path              ;
