...
public interface SwizzleTypeRegistry extends SwizzleTypeLookup
{
	...
	public static SwizzleTypeRegistry.Implementation New()
	{
		return new SwizzleTypeRegistry.Implementation();
	}
	
	public final class Implementation implements SwizzleTypeRegistry
	{
