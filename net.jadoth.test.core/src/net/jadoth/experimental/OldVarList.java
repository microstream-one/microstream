...
//		return forwardGet(this.head, index);
	...
	public OldVarList<E> addAll(final E[] elements, final int offset, final int length)
	{
		if(length == 0)
		{
			...
			throw new net.jadoth.meta.NotImplementedYetError(); // FIXME VarList#addAll(length < 0)
		}
...
//		++this.size;
	...
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIXME VarList#optimizeIndex
	}

	private void rebuildIndex()
	{
		throw new net.jadoth.meta.NotImplementedYetError(); // FIXME VarList#rebuildIndex
	}
