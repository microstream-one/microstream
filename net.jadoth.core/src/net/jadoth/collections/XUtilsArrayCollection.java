...
public final class XUtilsArrayCollection
{
	...
	)
	{
		AbstractArrayStorage.forwardConditionalIterate(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()),
			0,
			predicate,
			procedure
		);
	...
	)
	{
		return AbstractArrayStorage.rangedBinarySearch(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, element, comparator
		);
	}
	...
	boolean rngHasUniqueValues(final A a, final int offset, final int length)
	{
		return AbstractArrayStorage.rangedHasUniqueValues(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length
		);
	}
	...
	{
		return AbstractArrayStorage.rangedHasUniqueValues(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, equalator
		);
	}
...
//	}
	...
	{
		return AbstractArrayStorage.rangedContainsAll(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, elements
		);
	}
	...
	E rngMax(final A a, final int offset, final int length, final Comparator<? super E> comparator)
	{
		return AbstractArrayStorage.rangedAggregate(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, new AggregateMax<>(comparator)
		);
	}
	...
	int rngIndexOf(final A a, final int offset, final int length, final E sample, final Equalator<? super E> equalator)
	{
		return AbstractArrayStorage.rangedScan(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, new IsCustomEqual<>(equalator, sample)
		);
	}
	...
	int rngIndexOF(final A a, final int offset, final int length, final E element)
	{
		return AbstractArrayStorage.rangedIndexOF(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, element
		);
	}
	...
	{
		return AbstractArrayStorage.rangedCount(a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, element);
	}

	public static final <E, A extends AbstractSimpleArrayCollection<E> & XGettingSequence<E>>
	boolean rngIsSorted(final A a, final int offset, final int length, final Comparator<? super E> comparator)
	{
		return AbstractArrayStorage.rangedIsSorted(a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, comparator);
	}

	public static final <E, A extends AbstractSimpleArrayCollection<E> & XGettingSequence<E>,
	C extends Consumer<? super E>> C rngCopyTo(final A a, final int offset, final int length, final C target)
	{
		return AbstractArrayStorage.rangedCopyTo(a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, target);
	}

	public static final <E, A extends AbstractSimpleArrayCollection<E> & XGettingSequence<E>>
	A rngIterate(final A a, final int offset, final int length, final Consumer<? super E> procedure)
	{
		AbstractArrayStorage.rangedIterate(a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, procedure);
		return a;
	}
	...
	)
	{
		AbstractArrayStorage.rangedConditionalIterate(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, predicate, procedure
		);
		return a;
	}
	...
	E rngFind(final A a, final int offset, final int length, final E sample, final Equalator<? super E> equalator)
	{
		return AbstractArrayStorage.rangedQueryElement(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, new IsCustomEqual<>(equalator, sample), null
		);
	}
	...
	{
		return AbstractArrayStorage.rangedContains(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, predicate
		);
	}
	...
	{
		return AbstractArrayStorage.rangedApplies(a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, predicate);
	}
	...
	{
		return AbstractArrayStorage.rangedQueryElement(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, predicate, null
		);
	}
	...
	{
		return AbstractArrayStorage.rangedToArray(a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, type);
	}

	public static final <E, A extends AbstractSimpleArrayCollection<E> & XGettingSequence<E>>
	Object[] rngToArray(final A a, final int offset, final int length)
	{
		return AbstractArrayStorage.rangedToArray(a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length);
	}
	...
	{
		return AbstractArrayStorage.rangedEqualsContent(a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, list, equalator);
	}
	...
	R rngAggregate(final A a, final int offset, final int length, final Aggregator<? super E, R> aggregate)
	{
		AbstractArrayStorage.rangedIterate(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, aggregate
		);
	...
	VarString rngAppendTo(final A a, final int offset, final int length, final VarString vc)
	{
		return AbstractArrayStorage.rangedAppendTo(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, vc
		);
	}
	...
	{
		return AbstractArrayStorage.rangedAppendTo(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, vc, separator
		);
	}
	...
	{
		return AbstractArrayStorage.rangedAppendTo(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, vc, appender
		);
	}
	...
	{
		return AbstractArrayStorage.rangedAppendTo(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, vc, appender, separator
		);
	}
	...
	{
		return AbstractArrayStorage.rangedScan(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, new IsGreater<>(comparator)
		);
	}
	...
	{
		return AbstractArrayStorage.rangedScan(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, new IsSmaller<>(comparator)
		);
	}
	...
	C rngDistinct(final A a, final int offset, final int length, final C target)
	{
		return AbstractArrayStorage.rangedDistinct(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, target
		);
	}
	...
	{
		return AbstractArrayStorage.rangedDistinct(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, target, equalator
		);
	}
	...
	)
	{
		return AbstractArrayStorage.rangedIntersect(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, samples, equalator, target
		);
	}
	...
	)
	{
		return AbstractArrayStorage.rangedReplaceOne(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, oldElement, newElement, equalator
		);
	}
	...
	{
		return AbstractArrayStorage.rangedReplaceOne(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, oldElement, newElement
		);
	}
	...
	int rngReplaceAll(final A a, final int offset, final int length, final XMap<E, E> replacementMapping)
	{
		return AbstractArrayStorage.rangedReplaceAll(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, replacementMapping
		);
	}
	...
	{
		return AbstractArrayStorage.rangedReplaceAll(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, (XGettingCollection<E>)oldElements, newElement
		);
	}
	...
	{
		return AbstractArrayStorage.rangedReplaceOne(
			a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, predicate, newElement
		);
	}
	...
	{
		AbstractArrayStorage.rangedSortQuick(a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, comparator);
		return a;
	}
	...
	{
		AbstractArrayStorage.rangedShuffle(a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length);
		return a;
	}
	...
	{
		AbstractArrayStorage.rangedSortMerge(a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, comparator);
		return a;
	}
	...
	{
		AbstractArrayStorage.rangedSort(a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, comparator);
		return a;
	}
	...
	{
		AbstractArrayStorage.rangedSortInsertion(a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length, comparator);
		return a;
	}
	...
	{
		AbstractArrayStorage.rangedReverse(a.internalGetStorageArray(), JadothTypes.to_int(a.size()), offset, length);
		return a;
	}
